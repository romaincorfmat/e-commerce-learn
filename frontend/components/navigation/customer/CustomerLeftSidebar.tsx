...
const CustomerLeftSidebar = () => {
  return (
    <div className="sticky top-0 left-0 max-lg:hidden lg:w-[250px] border-r bg-gray-100 overflow-y-hidden h-screen px-4 pt-20 pb-12 justify-between flex flex-col">
